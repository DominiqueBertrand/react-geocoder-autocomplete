...
import {
  ...
  GeoapifyContext,
} from '@coog/react-geocoder-autocomplete'
...
const App = () => {
  ...
  function handleFilterChange(event) {
    ...
    if (positionName === 'none') {
      ...
      setFilterByCircle({
        lat: 55.75638407268255,
        lon: 37.599963771743774,
        radiusMeters: 100000,
      })
      setFilterByCountryCode(null)
      setFilterByRect(null)
      ...
      setFilterByCountryCode(null)
      setFilterByRect({
        lat1: 40.30722603742393,
        lon1: -74.64393682324243,
        lat2: 41.09089986660214,
        lon2: -73.26457192453972,
      })
  ...
  function handleBiasChange(event) {
    ...
    if (positionName === 'none') {
      ...
      setBiasByProximity(null)
      setBiasByCircle({
        lat: 1.3132160633313674,
        lon: 103.74138874820653,
        radiusMeters: 100000,
      })
    } else if (positionName === 'rect') {
      setBiasByCountryCode(null)
      ...
      setBiasByProximity(null)
      setBiasByRect({
        lat1: 3.162983444447292,
        lon1: -85.96878977760184,
        lat2: 11.917122016913211,
        lon2: -74.64581654099129,
      })
    } else if (positionName === 'country') {
      setBiasByRect(null)
      setBiasByCircle(null)
  ...
  return (
    <div>
      ...
      <div className='setting' onChange={handleFilterChange}>
        ...
        <input type='radio' value='circle' name='filter' /> By circle (Moscow +
        100km)
      ...
      <div className='setting' onChange={handleBiasChange}>
        ...
        <input type='radio' value='country' name='bias' /> By country
        (Australia)
        <input type='radio' value='circle' name='bias' /> By Circle (Singapore +
        100km)
        <input type='radio' value='rect' name='bias' /> By Rect (Panama)
        <input type='radio' value='proximity' name='bias' /> By Proximity
        (Lisboa)
      </div>
